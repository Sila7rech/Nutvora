...
export default function ProfilePage() {
  ...
  if (loading) return <main><Header /><section className="profile-page"><div className="profile-preferences"><PreferencesMenu /></div><div className="profile-loading">Chargement de votre espace...</div></section></main>;
